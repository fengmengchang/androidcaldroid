...
public class CaldroidFragment extends DialogFragment {
	...
	public final static String DIALOG_TITLE = "dialogTitle", MONTH = "month", YEAR = "year", SHOW_NAVIGATION_ARROWS = "showNavigationArrows", DISABLE_DATES = "disableDates",
			...
			SIX_WEEKS_IN_CALENDAR = "sixWeeksInCalendar",IS_SHOW_TODAT_TXT = "isShowTodayTxt", ENABLE_CLICK_ON_DISABLED_DATES = "enableClickOnDisabledDates", SQUARE_TEXT_VIEW_CELL = "squareTextViewCell",
	 ...
	 *是否显示当前为“今天”
	 */
	private boolean isShowTodayTxt = false;
	...
	public Map<String, Object> getCaldroidData() {
		...
		caldroidData.put(IS_SHOW_TODAT_TXT, isShowTodayTxt);
	...
	public Bundle getSavedStates() {
		...
		bundle.putBoolean(IS_SHOW_TODAT_TXT, isShowTodayTxt);
	...
	public boolean isShowTodayTxt() {
		return isShowTodayTxt;
	}

	public void setShowTodayTxt(boolean isShowTodayTxt) {
		this.isShowTodayTxt = isShowTodayTxt;
	}
	...
	protected void retrieveInitialArgs() {
		...
		if (args != null) {
			...
			isShowTodayTxt = args.getBoolean(IS_SHOW_TODAT_TXT, false);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		LinearLayout calendar_title_view = (LinearLayout) view.findViewById(R.id.calendar_title_view);
